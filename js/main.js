...
camera.position.z = objToRender === "retro_computer" ? 3 : 500;
camera.position.x = 2;
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "retro_computer" ? 5 : 1);
scene.add(ambientLight);

//This adds controls to the camera, so we can rotate / zoom it with the mouse
if (objToRender === "retro_computer") {
